...
export async function getStaticProps(context) {
  ...
  return {
    props: {
      ...
      c1name: post.c1name || null,
      c1number: post.c1no || null,
      c2name: post.c2name || null,
      c2number: post.c2no || null,
      regfee: post.regfee ?? null,
      pricepool: post.pricepool ?? null,
      enddate: post.enddate ?? null,
      eventDateString: post.eventDateString || null,
      register: post.reg ?? null,
      reglink: post.reglink ?? null,
      reg: post.reg ?? null,
      rulehead: post.ruleheader ?? null,
