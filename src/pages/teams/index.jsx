...
function Team(props) {
  ...
  const showUpdatingSoon = props.siteConfig?.teams?.showUpdatingSoon ?? false;

  return (
    <div className="h-fit w-screen bg-soothing_black">
      <Head>
        <title>Spoorthi26 - Teams</title>
      </Head>
      <Header id="navbar" />
        ...
        {showUpdatingSoon ? (
          <div className="flex flex-col items-center justify-center py-20 px-4">
            ...
            <p className="text-white/60 font-chakra text-lg md:text-xl text-center max-w-md">
              Our team details for SPOORTHI&apos; 26 are being updated. Stay tuned!
            </p>
          </div>
        ) : (
          <>
